      ...
      <div className="wolf-card p-6">
        ...
        {poolsError && (
          <div className="text-center py-10 space-y-3">
            <div className="text-[var(--wolf-amber)] text-sm font-semibold">Pool Data Unavailable</div>
            <p className="text-gray-400 text-sm max-w-md mx-auto">
              Could not load Uniswap V3 pool data from the intel service. The backend may be offline or unreachable.
            </p>
