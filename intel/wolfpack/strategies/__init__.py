...
from wolfpack.strategies.capitulation_flush import CapitulationFlushStrategy
...
from wolfpack.strategies.rsi2_connors import RSI2ConnorsStrategy
...
STRATEGIES: dict[str, type[Strategy]] = {
    ...
    "capitulation_flush": CapitulationFlushStrategy,
}
